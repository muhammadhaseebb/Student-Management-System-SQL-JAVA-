 ...
 * @author superuser
 */
public class viewCourseMaterials extends javax.swing.JFrame {

    /**
     * Creates new form viewCourseMaterials
   ...
   String course;
      ...
      public viewCourseMaterials(String id, String course) {
        initComponents();
        student_id = id;
        this.course = course;
        view();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("View Course Materials");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Link", "Name", "Format", "Section ID"
            }
        ));
    ...
    private void view() {                                         
        try{
            ...
            ResultSet result1 = st.executeQuery("select cm.id, cm.link, cm.name, cm.format, cm.section_id \n" +
                                                "from section s join registers r\n" +
                                                "on s.id = r.section_id\n" +
                                                "join coursematerial cm\n" +
                                                "on s.id = cm.section_id\n" +
                                                "where s.courses_code = '"+course+"' AND r.student_regno = '"+student_id+"'");
            while(result1.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewCourseMaterials.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewCourseMaterials().setVisible(true);
            }
        });
    }
