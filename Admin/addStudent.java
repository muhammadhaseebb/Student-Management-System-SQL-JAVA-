...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        department_tf.setText("Enter Department Code of the Student");
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("INSERT INTO STUDENT(REGNO, PASSWORD, EMAIL, PHONE,DEPARTMENT_DPTCODE,NAME )" + " VALUES (?, ?, ?, ?, ?,?)");
            prepareStatement.setString(1, reg_no_tf.getText());
            prepareStatement.setString(2, password_tf.getText());
            prepareStatement.setString(3, email_tf.getText());
            prepareStatement.setString(4, phone_notf.getText());
            prepareStatement.setString(5, department_tf.getText());
            prepareStatement.setString(6, name_tf.getText());
