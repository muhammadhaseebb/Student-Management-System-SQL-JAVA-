...
public class updateDepartment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        code_tf.setText("Enter Code of Department You Want to Edit");
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        try{
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("UPDATE DEPARTMENT SET NAME=? WHERE DPTCODE=? ");
            
            prepareStatement.setString(1, name_tf.getText());
            prepareStatement.setString(2, code_tf.getText());
        ...
        code_tf.setText("Enter Department Code");
        name_tf.setText("Enter Name of the Department");
