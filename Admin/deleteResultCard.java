 ...
 * @author Itcomplex
 */
public class deleteResultCard extends javax.swing.JFrame {
    JFrame f;

    /**
     * Creates new form deleteResultCard
     */
    public deleteResultCard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        reg_no_tf.setText("Enter ID of Result Card");
        ...
        jLabel12.setText("DELETE RESULT CARD");
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        try{
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("DELETE FROM resultcard WHERE id=?");
...
//            java.util.logging.Logger.getLogger(deleteResultCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new deleteResultCard().setVisible(true);
//            }
//        });
//    }
