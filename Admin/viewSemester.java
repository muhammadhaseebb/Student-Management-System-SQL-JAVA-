 ...
 * @author Itcomplex
 */
public class viewSemester extends javax.swing.JFrame {

    /**
     * Creates new form viewSemester
     */
    public viewSemester() {
        initComponents();
        view();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("VIEW SEMESTER");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Enrollment", "Semester", "Year", "Section name"
            }
        ));
    ...
    private void view() {
        ...
        try{
            ...
            ResultSet result = st.executeQuery("select sem.enrollement, sem.semester, sem.year, sec.name\n" +
                                                "from semester sem  JOIN Section sec  \n" +
                                                "ON (sem.enrollement = sec.semester_enrollement)");
            while(result.next()){
...
//            java.util.logging.Logger.getLogger(viewSemester.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new viewSemester().setVisible(true);
//            }
//        });
//    }
