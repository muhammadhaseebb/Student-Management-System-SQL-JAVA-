...
import com.mycompany.databaseproject.Admin.addStudent;
...
public class updateStudent extends javax.swing.JFrame {
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        try{
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("UPDATE STUDENT SET EMAIL=?, PHONE=?,DEPARTMENT_DPTCODE=?, NAME=? WHERE REGNO=?");
            prepareStatement.setString(1, email_tf.getText());
            prepareStatement.setString(2, phone_notf.getText());
            prepareStatement.setString(3, department_tf.getText());
            prepareStatement.setString(4, name_tf.getText());
