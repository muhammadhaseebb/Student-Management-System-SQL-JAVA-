...
import com.mycompany.databaseproject.Admin.updateSection;
import com.mycompany.databaseproject.Admin.viewSection;
import com.mycompany.databaseproject.Admin.deleteSection;
import com.mycompany.databaseproject.Admin.manageSection;
...
public class addSection extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(enrolled_students_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(95, 95, 95))
        );
    ...
    private void add_btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btn1ActionPerformed
        try{
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("INSERT INTO SECTION(ID, NAME, ENROLLEDSTUDENTS, COURSES_CODE, INSTRUCTOR_ID, SEMESTER_ENROLLEMENT )" + " VALUES (?, ?, ?, ?, ?, ?)");
            prepareStatement.setString(1, id_tf.getText());
            prepareStatement.setString(2, name_tf.getText());
            prepareStatement.setString(3, enrolled_students_tf.getText());
            prepareStatement.setString(4, course_code_tf.getText());
            prepareStatement.setString(5, instructor_id_tf.getText());
            prepareStatement.setString(6, enrollement_tf.getText());
